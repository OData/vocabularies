...
###2.2.1	Client requests service metadata
...
####2.2.1.1	ScopedServiceVersionInfo Annotation
...
####2.2.1.2	Example: Scope Version Information
...
####2.2.1.3	Example: Service and Scope Version Information
...
###2.2.2	Client calls a service with scope version information
...
####2.2.2.1	Version transmission logic
...
####2.2.2.2	Scope Version Information Format
...
####2.2.2.4	Query String Parameter Version Format
...
####2.2.2.5	Providing Service Version and Scope Version together
...
####2.2.2.6	Example: Client calls a service with scope version information only in a header
...
####2.2.2.7	Example: Client calls a service with scope version information only in a query string parameter
Given the following version information in metadata:
...
####2.2.2.8	Example: Client calls a service with service and scope version information
Given the following version information in metadata:
...
####2.2.2.9	Example: Client calls a service with service and scope version in shared query string parameter
Given the following version information in metadata:
